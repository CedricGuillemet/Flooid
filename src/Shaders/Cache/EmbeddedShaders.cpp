...
BGFX_EMBEDDED_SHADER(AdvectPaged_cs),
BGFX_EMBEDDED_SHADER(AllocatePages_cs),
BGFX_EMBEDDED_SHADER(AllocateSubPages_cs),
BGFX_EMBEDDED_SHADER(Clear_cs),
BGFX_EMBEDDED_SHADER(ClearPages_cs),
BGFX_EMBEDDED_SHADER(CommitFreePages_cs),
...
BGFX_EMBEDDED_SHADER(DownscalePaged_cs),
BGFX_EMBEDDED_SHADER(FrameInit_cs),
...
BGFX_EMBEDDED_SHADER(ResidualPaged_cs),
BGFX_EMBEDDED_SHADER(UpscalePaged_cs),
